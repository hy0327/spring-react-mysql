...
import com.hyunil.board_back.dto.request.user.PatchNicknameRequestDto;
import com.hyunil.board_back.dto.request.user.PatchProfileImageRequestDto;
...
import com.hyunil.board_back.dto.response.user.PatchNicknameResponseDto;
import com.hyunil.board_back.dto.response.user.PatchProfileImageResponseDto;
...
public class UserServiceImplement implements UserService{
    ...
    public ResponseEntity<? super PatchNicknameResponseDto> patchNickname(PatchNicknameRequestDto dto, String email) {
        try {
            ...
            if(userEntity == null) PatchBoardResponseDto.noExistUser();
