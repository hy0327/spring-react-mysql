...
export default function Authentication() {
  ...
  const SignInCard = () => {
    ...
    //        event handler : 이메일 인풋 키다운 클릭 이벤트 처리   //
    ...
    //        event handler : 패스워드 인풋 키다운 클릭 이벤트 처리   //
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-description-box'>
              <div className='auth-description'>
                {'신규 사용자이신가요? '}
                <span className='auth-description-link' onClick={onSignUpLinkHandler}>{'회원가입'}</span>
              </div>
            </div>
          </div>
        </div>
  ...
  const SignUpCard = () => {
    ...
    //        event handler : 패스워드 확인 변경 이벤트처리        //
    ...
    //        event handler : 상세주소 변경 이벤트처리        //
    const onAddressDetailChangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
      const { value } = event.target;
      setAddressDetail(value);
    }
    //        event handler : 개인정보동의 체크박스 클릭 이벤트처리        //
    const onAgreedPersonalClickHandler = () => {
      setAgreedPersonal(!agreedPersonal);
      setAgreedPersonalError(false);
    }
    //        event handler : 패스워드 버튼 클릭 이벤트처리        //
    const onPasswordButtonClickHandler = () => {
    ...
    //        event handler : 패스워드 확인 버튼 클릭 이벤트처리        //
    ...
    //        event handler : 다음 단계 버튼 클릭 이벤트처리        //
        ...
        <div className='auth-card-box'>
          ...
          <div className='auth-card-bottom'>
            ...
            <div className='auth-description-box'>
              <div className='auth-description'>
                {'이미 계정이 있으신가요?'}
                <span className='auth-description-link' onClick={onSignInLinkHandler}>
                  {'로그인'}
                </span>
              </div>
            </div>
